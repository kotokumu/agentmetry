...
export class LanguageSelector extends LocalizedElement {
  static styles = css`
    :host { display: block; }
    label { display: flex; min-height: 31px; align-items: center; gap: 7px; border: 1px solid var(--am-border); border-radius: 8px; padding: 0 8px 0 10px; color: var(--am-muted); background: var(--am-surface); font: 700 .64rem/1 "SFMono-Regular", "Cascadia Code", monospace; }
