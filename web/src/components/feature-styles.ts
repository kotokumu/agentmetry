...
export const featurePanelStyles = css`
  * { box-sizing: border-box; }
  ...
  .eyebrow { margin: 0 0 6px; color: var(--am-accent); font: 600 .875rem/1.3 "SFMono-Regular", "Cascadia Code", monospace; letter-spacing: .02em; }
  h2 { margin: 0 0 12px; font: 650 1.125rem/1.3 Inter, ui-sans-serif, sans-serif; letter-spacing: .01em; }
